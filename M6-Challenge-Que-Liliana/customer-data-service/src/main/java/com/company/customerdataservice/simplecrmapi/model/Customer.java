package com.company.customerdataservice.simplecrmapi.model;
...
public class Customer {
	...
	@Override
	public int hashCode() {
		return Objects.hash(getId(), getFirstName(), getLastName(), getEmail(), getAddress1(), getPhone(), getAddress2(), getCity(), getPostalCode(), getState(), getCompany(), getCountry());
	}
}
